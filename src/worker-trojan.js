        ...
        try {
            ...
            if (!upgradeHeader || upgradeHeader !== "websocket") {
                ...
                switch (url.pathname) {
	              ...
	              let sa = tmp_path.searchParams.get('sa');
	              sa = (sa !== null && sa !== '') ? sa : sha224Password;
	              sha224Password = isValidSHA224(sa) ? sa : atob(sa);
...
async function handleTCPOutBound(request, remoteSocket, addressRemote, portRemote, rawClientData, webSocket, log) {
